...
const Services = () => {
  const services = [
    ...
    {
      icon: <Brain className="text-accent" size={40} />,
    ...
    <section id="services" className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-light mb-4">Services</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-gray-800 p-8 rounded-xl hover:bg-gray-750 transition-all duration-300 hover:scale-105 group border border-secondary hover:border-accent"
            >
