        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold text-light">
                Blũ Dennis
              </h1>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="relative w-80 h-96 bg-gradient-to-br from-secondary to-primary rounded-2xl overflow-hidden border border-secondary">
                <img 
